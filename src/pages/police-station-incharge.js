  ...
  return (
    <>
      <Head>
        ...
        <title>Police Station Incharge | Dhule Police</title>
      </Head>
      ...
      <main className="min-h-screen">
        ...
        <h1 className="text-center font-semibold text-2xl text-gray-700 pt-10 px-5">
          {t("police_station")}{" "}
          <span className="text-orange-500">{t("incharge")}</span>
        </h1>
            ...
            records.map((record) => {
              return (
                ...
                >
                  ...
                  <div className="font-semibold text-gray-900 mt-2 pb-2 border-b">
                    {Ctx.lang === "en" && (
                      <div>{record.psId.name} Police Station</div>
                    )}
                    {Ctx.lang === "mr" && (
                      <div>{record.psId.name_in_marathi} पोलीस ठाणे</div>
                    )}
                  </div>
