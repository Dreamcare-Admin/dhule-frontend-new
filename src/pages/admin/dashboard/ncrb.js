...
const Record = () => {
  ...
  const fetchrecords = async () => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/records-by-tag?tag=ncrb&page=${currentPage}&limit=${limit}`,
        {
          method: "GET",
        }
      );
  ...
  return (
    <ProtectedAdminRoute>
      <>
        <Head>
          <title>NCRB | Admin Dashboard</title>
        </Head>
          ...
          <div className="flex flex-row">
            ...
            <div className="w-full lg:w-4/5 mt-20 mx-5 bg-white shadow p-5">
              ...
              <div className="mb-52 w-full bg-white">
                <h1 className="font-semibold text-xl mt-10">NCRB Records</h1>
